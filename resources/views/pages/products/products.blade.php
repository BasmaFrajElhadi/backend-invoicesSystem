                                                ...
                                                @foreach ($products as $product)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            data-pro_id="{{ $product->id }}" data-name ="{{$product->product_name}}" data-section_name="{{ $product->section->section_name }}"
                                                            data-description="{{ $product->description }}" data-toggle="modal" href="#edit_Product"
                                                            title="تعديل" data-target="#edit_Product"><i class="las la-pen"></i></a>
                                                            @endcan
                                                            @can('حذف منتج')
