                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div  class="dropdown-menu tx-13">
                                                    @can('تعديل الفاتورة')
                                                    {{-- update invoice --}}
                                                    <a class="dropdown-item" href="{{url('/invoices/'.$invoice->id . '/edit')}}"><i class="las la-edit"></i> &nbsp;&nbsp;تعديل الفاتورة</a>
                                                    @endcan
                                                    @can('حذف الفاتورة')
                                                    {{-- delete the invoice --}}
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
                                                        data-toggle="modal" data-target="#delete_invoice"><i class="text-danger fas fa-trash-alt"></i>
                                                        &nbsp;&nbsp;حذف الفاتورة</a>
                                                    @endcan
                                                    @can('تغير حالة الدفع')
                                                    {{--update the status of invoice --}}
                                                    <a class="dropdown-item" href="{{url('statusShow/'.$invoice->id )}}"><i class="las la-edit"></i> &nbsp;&nbsp;تعديل حالة الدفع </a>
                                                    @endcan
                                                    @can('ارشفة الفاتورة')
                                                    <a class="dropdown-item" href="#" data-invoice_id="{{ $invoice->id }}"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{ url('invoices/destroy') }}" method="post"> @csrf
                        @method('delete')
                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <form action="{{url('invoiceArchive/destroy')}}" method="post">
                        @csrf
                        @method('delete')
                </div>
                <div class="modal-body">
